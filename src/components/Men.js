...
export default function Men() {
  const addToWishList = (product, action) => {
    ...
    <div>
      ...
      <div>
         {/* BANNER BEGIN */}
         <section className="banner set-bg category-banner" style={{ backgroundImage: 'url("img/banner/5.jpeg")' }}>
       ...
       <div className="col-lg-3 col-md-4 col-sm-6 mix kids">
          <div className="product__item">
            <div className="product__item__pic ">
              <Link to="product-details.html?id=1">
                <img
                  ...
                  src="img/product/mens/mens-1.png"
                  alt="SHEIN Men Solid Blazer &amp; Suit Pants Set"
                />
            ...
            <div className="product__item__text">
              <h6>
                <Link to="product-details.html?id=1">
                SHEIN Men Solid Blazer &amp; Suit Pants Set
                </Link>
              </h6>
              ...
              <div className="product__price">$ 95.99</div>
            </div>
          </div>
        </div>
          ...
          <div className="product__item">
            <div className="product__item__pic ">
              <Link to="product-details.html?id=2">
                <img
                  className="product__item__pic"
                  src="img/product/mens/mens-13.png"
                  alt="Men Olive Green Solid Active Bomber Jacket"
                />
            ...
            <div className="product__item__text">
              <h6>
                <Link to="product-details.html?id=2">Men Olive Green Solid Active Bomber Jacket</Link>
              </h6>
              <div className="rating">
                <i className="fa fa-star"> </i> <i className="fa fa-star"> </i> <i className="fa fa-star"> </i>{' '}
          ...
          <div className="product__item">
            <div className="product__item__pic ">
              <Link to="product-details.html?id=1">
                <img
                  className="product__item__pic"
                  src="img/product/mens/mens-18.png"
                  alt="Train Icons 3-Bar Logo Training T-Shirt"
                />
            ...
            <div className="product__item__text">
              <h6>
                <Link to="product-details.html?id=1">
                Train Icons 3-Bar Logo Training T-Shirt
                </Link>
              </h6>
              <div className="rating">
                <i className="fa fa-star"> </i> <i className="fa fa-star"> </i> <i className="fa fa-star"> </i>{' '}
              ...
              <div className="product__price">$ 20.35</div>
            </div>
          </div>
        </div>
          ...
          <div className="product__item">
            <div className="product__item__pic ">
              <Link to="product-details.html?id=1">
                <img
                  className="product__item__pic"
                  src="img/product/mens/pants-4.png"
                  alt="men slant pocket drawstring waist pants"
                />
            ...
            <div className="product__item__text">
              <h6>
                <Link to="product-details.html?id=1">
                Men slant pocket drawstring waist pants
                </Link>
              </h6>
              <div className="rating">
                <i className="fa fa-star"> </i> <i className="fa fa-star"> </i> <i className="fa fa-star"> </i>{' '}
              ...
              <div className="product__price">$ 27.49</div>
            </div>
          </div>
        </div>
          ...
          <div className="product__item">
            <div className="product__item__pic ">
              <Link to="product-details.html?id=1">
                <img
                  className="product__item__pic"
                  src="img/product/mens/pants-2.png"
                  alt="men letter graphic drawstring cargo pants"
                />
              </Link>
              <div className="label new">100% New</div>
              <ul className="product__hover">
            ...
            <div className="product__item__text">
              <h6>
                <Link to="product-details.html?id=1">
                Men letter graphic drawstring cargo pants"
                </Link>
              </h6>
              <div className="rating">
                <i className="fa fa-star"> </i> <i className="fa fa-star"> </i> <i className="fa fa-star"> </i>{' '}
              ...
              <div className="product__price">$ 25.99</div>
            </div>
          </div>
        </div>
          ...
          <div className="product__item">
            <div className="product__item__pic ">
              <Link to="product-details.html?id=1">
                <img
                  className="product__item__pic"
                  src="img/product/mens/shoes.png"
                  alt="men colorblock block lace-up front knit sneakers running shoes"
                />
            ...
            <div className="product__item__text">
              <h6>
                <Link to="product-details.html?id=1">
                Men colorblock block lace-up front knit Sneakers Running Shoes
                </Link>
              </h6>
              <div className="rating">
                <i className="fa fa-star"> </i> <i className="fa fa-star"> </i> <i className="fa fa-star"> </i>{' '}
              ...
              <div className="product__price">$ 38.99</div>
            </div>
          </div>
        </div>
        </div>
